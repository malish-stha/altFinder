  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-2">
          <button 
            ...
            className={`inline-flex items-center gap-2 rounded-xl border px-4 py-2 text-xs font-semibold tracking-wide uppercase transition-all ${
              hasUpvoted 
      ...
      <section className="mb-12">
        ...
        {githubStats && (
          <div className="flex flex-wrap items-center gap-4 mt-6">
            <div className="flex items-center gap-1.5 bg-yellow-500/10 border border-yellow-500/10 text-yellow-300 px-3 py-1 rounded-full text-xs font-mono">
              <Star className="h-3.5 w-3.5 fill-current" /> {githubStats.stars.toLocaleString()} Stars
            </div>
            <div className="flex items-center gap-1.5 bg-blue-500/10 border border-blue-500/10 text-blue-300 px-3 py-1 rounded-full text-xs font-mono">
              <GitFork className="h-3.5 w-3.5" /> {githubStats.forks.toLocaleString()} Forks
            </div>
            <div className="flex items-center gap-1.5 bg-green-500/10 border border-green-500/10 text-green-300 px-3 py-1 rounded-full text-xs font-mono">
      ...
      <section className="grid gap-6 md:grid-cols-2 mb-12">
        ...
        {/* Commercial Tool */}
        <div className="rounded-2xl border border-red-500/10 bg-red-500/2 p-6 backdrop-blur-xl hover:shadow-[0_0_20px_rgba(239,68,68,0.05)] hover:border-red-500/20 transition-all">
        ...
        {/* Open Source Tool */}
        <div className="rounded-2xl border border-green-500/10 bg-green-500/2 p-6 backdrop-blur-xl hover:shadow-[0_0_20px_rgba(34,197,94,0.05)] hover:border-green-500/20 transition-all">
          <div className="flex items-center justify-between mb-4">
      ...
      {features.length > 0 && (
        <section className="mb-12">
          ...
          <div className="overflow-hidden rounded-2xl border border-white/5 bg-white/2 backdrop-blur-xl">
      ...
      {/* Expert Analysis */}
      <section className="rounded-2xl border border-white/5 bg-white/2 p-6 md:p-8 backdrop-blur-xl mb-12">
      ...
      <section className="flex flex-col sm:flex-row justify-center gap-4">
        {comparison.commercialWebsite && (
          <a href={comparison.commercialWebsite} target="_blank" rel="noopener noreferrer">
            <Button variant="outline" className="w-full sm:w-auto border-white/10 hover:bg-white/5 text-slate-300 rounded-xl px-6 py-5">
        ...
        {comparison.alternativeWebsite && (
          <a href={comparison.alternativeWebsite} target="_blank" rel="noopener noreferrer">
            <Button className="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl px-8 py-5 shadow-lg">
